...
# bench_1_mask = frame[(frame["DATE"] == date) & (frame["TYPE"] == "BENCH 1") & (frame["STATION"] == station)][["ENTRIES","EXITS"]].sum(axis=1)
# count_1_mask = frame[(frame["DATE"] == date) & (frame["TYPE"] == "COUNT 1") & (frame["STATION"] == station)][["ENTRIES","EXITS"]].sum(axis=1)
# count_2_mask = frame[(frame["DATE"] == date) & (frame["TYPE"] == "COUNT 2") & (frame["STATION"] == station)][["ENTRIES","EXITS"]].sum(axis=1)
# bench_2_mask = frame[(frame["DATE"] == date) & (frame["TYPE"] == "BENCH 2") & (frame["STATION"] == station)][["ENTRIES","EXITS"]].sum(axis=1)
# count_3_mask = frame[(frame["DATE"] == date) & (frame["TYPE"] == "COUNT 3") & (frame["STATION"] == station)][["ENTRIES","EXITS"]].sum(axis=1)
...
sns.heatmap(flippedframe.applymap(lambda x: sum(x), na_action='ignore'))
